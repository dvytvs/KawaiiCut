...
import { 
  ...
  Home, LayoutTemplate, FolderOpen, PlaySquare, Trash2, RefreshCcw, XCircle, Ban
} from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex bg-bg-main text-text-main overflow-hidden font-sans transition-colors">
